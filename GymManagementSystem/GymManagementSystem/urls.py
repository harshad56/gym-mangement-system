...
urlpatterns = [
    ...
    path('deletePackageType/<int:pid>',
         deletePackageType, name='deletePackageType'),
    ...
    path('discover_more/', discover_more, name='discover_more'),
    path('discover_more1/', discover_more1, name='discover_more1'),
    path('discover_more2/', discover_more2, name='discover_more2'),
    path('discover_more3/', discover_more3, name='discover_more3'),
    path('discover_more4/', discover_more4, name='discover_more4'),
    path('discover_more5/', discover_more5, name='discover_more5'),
